	...
	public static void main(String[] args) {
		...
		do{
			...
			if(life == 2){
				...
				System.out.println("You've decided to suppress your findings and...well Houston (ground control) has decided to leave you stranded on\n"
									+ "Mars in order to suppress the truth about life beyond Earth!");
			}else if(life == 5){
